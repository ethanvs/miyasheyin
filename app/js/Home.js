define(function(require,exports,module){
	...
	// 		var _html2 = require('view/news.html');
	// 		var _html3 = require('view/serve.html');
	// 		var _html4 = require('view/works.html');
	// 		var _html5 = require('view/contect.html');

	// 		var _htmlFn = _.template(_html);
	// 		var _htmlFn2 = _.template(_html2);
	// 		var _htmlFn3 = _.template(_html3);
	// 		var _htmlFn4 = _.template(_html4);
	// 		var _htmlFn5 = _.template(_html5);


	// 		var navA = $('.hd .nav li');
	// 		console.log(navA);
	// 		var viewA = [_htmlFn,_htmlFn2,_htmlFn3,_htmlFn4,_htmlFn5];

	// 		navA.click(function(){
	// 			var _index = navA.index($(this));
	// 			$('#view').html( viewA[_index]() );
	// 		});
